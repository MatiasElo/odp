 ...
 * should never use the generic names (e.g. _RING_INIT) directly. */
	...
	#define _RING_INIT		ring_mpmc_rst_u32_init
	#define _RING_DEQ		ring_mpmc_rst_u32_deq
	#define _RING_DEQ_MULTI		ring_mpmc_rst_u32_deq_multi
	#define _RING_DEQ_BATCH		ring_mpmc_rst_u32_deq_batch
	#define _RING_ENQ		ring_mpmc_rst_u32_enq
	#define _RING_ENQ_MULTI		ring_mpmc_rst_u32_enq_multi
	#define _RING_LEN		ring_mpmc_rst_u32_len
	...
	#define _RING_INIT		ring_mpmc_rst_u64_init
	#define _RING_DEQ		ring_mpmc_rst_u64_deq
	#define _RING_DEQ_MULTI		ring_mpmc_rst_u64_deq_multi
	#define _RING_DEQ_BATCH		ring_mpmc_rst_u64_deq_batch
	#define _RING_ENQ		ring_mpmc_rst_u64_enq
	#define _RING_ENQ_MULTI		ring_mpmc_rst_u64_enq_multi
	#define _RING_LEN		ring_mpmc_rst_u64_len
#elif _ODP_RING_TYPE == _ODP_RING_TYPE_PTR
	#define _ring_mpmc_rst_gen_t	ring_mpmc_rst_ptr_t
	#define _ring_mpmc_rst_data_t	void *

	#define _RING_INIT		ring_mpmc_rst_ptr_init
	#define _RING_DEQ		ring_mpmc_rst_ptr_deq
	#define _RING_DEQ_MULTI		ring_mpmc_rst_ptr_deq_multi
	#define _RING_DEQ_BATCH		ring_mpmc_rst_ptr_deq_batch
	#define _RING_ENQ		ring_mpmc_rst_ptr_enq
	#define _RING_ENQ_MULTI		ring_mpmc_rst_ptr_enq_multi
	#define _RING_LEN		ring_mpmc_rst_ptr_len
#endif

/* Initialize ring */
static inline void _RING_INIT(_ring_mpmc_rst_gen_t *ring)
{
...
static inline uint32_t _RING_DEQ(_ring_mpmc_rst_gen_t *ring, uint32_t mask,
...
static inline uint32_t _RING_DEQ_MULTI(_ring_mpmc_rst_gen_t *ring, uint32_t mask,
...
static inline uint32_t _RING_DEQ_BATCH(_ring_mpmc_rst_gen_t *ring, uint32_t mask,
				       _ring_mpmc_rst_data_t data[], uint32_t num)
{
	uint32_t head, tail, new_head, i;
...
static inline void _RING_ENQ(_ring_mpmc_rst_gen_t *ring, uint32_t mask,
			     _ring_mpmc_rst_data_t data)
{
...
static inline void _RING_ENQ_MULTI(_ring_mpmc_rst_gen_t *ring, uint32_t mask,
				   _ring_mpmc_rst_data_t data[], uint32_t num)
{
...
static inline uint32_t _RING_LEN(_ring_mpmc_rst_gen_t *ring)
{
