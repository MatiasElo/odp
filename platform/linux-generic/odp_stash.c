...
{
	/* Success always */
	ring_mpmc_rst_u32_enq_multi(&stash->ring_u32.hdr, stash->ring_mask, (uint32_t *)(uintptr_t)val, num);
...
{
	/* Success always */
	ring_mpmc_rst_u64_enq_multi(&stash->ring_u64.hdr, stash->ring_mask, (uint64_t *)(uintptr_t)val, num);
