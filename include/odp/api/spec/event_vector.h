 ...
 * event handles in the table directly (up to odp_pool_param_t::vector::max_size).
 ...
 *
 * The table memory is backed by a vector pool buffer. The ownership of the
 * table memory is linked to the ownership of the event. I.e. after sending the
 * event to a queue, the sender loses ownership to the table also.
 *
 * @param      evv       Event vector handle
