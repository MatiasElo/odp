 ...
 *   the packet so much that it no longer shares any packet data. It is
 *   implementation specific whether this stops the referencing relationship
 *   between the packets. An application may use odp_packet_is_referencing() on
 *   the referencing packet or odp_packet_has_ref() on the referenced packet to
 *   determine whether the relationship is still in effect. If the referencing
 *   relationship holds, the restrictions that apply to the referencing and
 *   referenced packet continue to apply.
 *
